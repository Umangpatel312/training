...
import com.config.WebApplicationContextConfig;
...
@WebAppConfiguration
@ContextConfiguration(classes = {MyWebApplicationInitializer.class,WebApplicationContextConfig.class})
public class AbstractControllerTest {
     ...
     */
    protected void setUp(DigitToWordController controller) {
